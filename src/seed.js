...
export const seedPhysioExercises = () => [
  ...
  /* ---- Rung 3 — loading ---- */
  {
    ...
    quickStretch: "quads and calf, both legs, before he takes the load", isStanding: true, inTram: true,
    mediaUrl: "", defaultDualTask: false,
  },
  {
    ...
    cues: [
      ...
      "Lower down slowly — feel your feet the whole way",
    ],
    watchFor: "WORKING = legs driving the rise with the hips extending, effort re-driven on each rep. COMPENSATION = the harness hoisting him up while the legs stay passive, or pulling on your hands or the frame to get up.",
    quickStretch: "quads and glutes, both legs", isStanding: false, inTram: true,
    mediaUrl: "", defaultDualTask: false,
  },
  {
    ...
    quickStretch: "", isStanding: true, inTram: true,
    mediaUrl: "", defaultDualTask: false,
  },
  ...
  /* ---- Rung 4 — extensor response (the milestone watch) ---- */
  {
    ...
    quickStretch: "quads and calf, immediately before each attempt", isStanding: true, inTram: true,
    mediaUrl: "", defaultDualTask: false,
  },
  {
    ...
    quickStretch: "quads, both legs", isStanding: true, inTram: true,
    mediaUrl: "", defaultDualTask: false,
  },
